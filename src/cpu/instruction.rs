...
impl Instruction8Bit {
    pub fn from_byte(byte: u8) -> Option<Instruction8Bit> {
        match byte {
            ...
            // RLA
            0x17 => Some(Instruction8Bit::Rla()),
            // RLCA
            0x07 => Some(Instruction8Bit::Rlca()),
            // RRA
            0x1f => Some(Instruction8Bit::Rra()),
            // RRCA
            0x0f => Some(Instruction8Bit::Rrca()),
            // ADD A,r
    ...
    pub fn as_byte(self) -> u8 {
        match self {
            ...
            // RLA
            Instruction8Bit::Rla() => 0x17,
            // RLCA
            Instruction8Bit::Rlca() => 0x07,
            // RRA
            Instruction8Bit::Rra() => 0x1f,
            // RRCA
            Instruction8Bit::Rrca() => 0x0f,
            // ADD A,r
